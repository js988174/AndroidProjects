...
import com.mandeum.dessert39.databinding.FragmentDialogBinding
...
class DialogFragment : DialogFragment() {
    ...
    companion object {
        ...
        private const val fragmentTag = "DialogFragment"
    ...
    override fun onCreateView(
        ...
        binding.saveBtn.setOnClickListener {
            val arr = listOf(starbuks1Text,starbuck2Text,starbuks3Text,starbuks4Text,starbuks5Text,starbuks6Text,
                starbuks7Text,starbuks8Text)
            val tab1 = arr.last()
            val drink1 : String = starbuks1Text + starbuck2Text +starbuks3Text + starbuks4Text +
            ...
            val arry11 = drink111 + tab1

            val arr2 = listOf(twosomePlace1Text, twosomePlace2Text, twosomePlace3Text, twosomePlace4Text, twosomePlace5Text,
                twosomePlace6Text, twosomePlace7Text, twosomePlace8Text, twosomePlace9Text)
            val tab2 = arr2.last()
            ...
            val arry12 = drink122 + tab2


            val arr3 = listOf(pallbarSet1Text,pallbarSet2Text,pallbarSet3Text,pallbarSet4Text,pallbarSet5Text,pallbarSet6Text,
                pallbarSet7Text, pallbarSet8Text, pallbarSet9Text)
            val tab3 = arr3.last()
            ...
            val arry13 = drink133 + tab3

            val arr4 = listOf(ediya1Text, ediya2Text, ediya3Text, ediya4Text, ediya5Text, ediya6Text, ediya7Text, ediya8Text,
                ediya9Text)
            val tab4 = arr4.last()
            ...
            val arry14 = drink144 + tab4

            val arr5 = listOf(megaCoffee1Text, megaCoffee2Text, megaCoffee3Text, megaCoffee4Text, megaCoffee5Text,
            ...
            val arry15 = drink155 + tab5

            val arr6 = listOf(backCoffee1Text, backCoffee2Text, backCoffee3Text, backCoffee4Text, backCoffee5Text,
                backCoffee6Text, backCoffee7Text, backCoffee8Text, backCoffee9Text)
            val tab6 = arr6.last()
            ...
            val arry16 = drink166 + tab6

            val arr7 = listOf(gongCha1Text, gongCha2Text, gongCha3Text, gongCha4Text, gongCha5Text,
                gongCha6Text, gongCha7Text, gongCha8Text, gongCha9Text)
            val tab7 = arr7.last()
            ...
            val arry17 = drink177 + tab7

            val arr8 = listOf(coffeeBean1Text,coffeeBean2Text,coffeeBean3Text,coffeeBean4Text,coffeeBean5Text,
                coffeeBean6Text, coffeeBean7Text, coffeeBean8Text, coffeeBean9Text)
            val tab8 = arr8.last()
