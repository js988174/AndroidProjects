...
class OrderNewRecyclerAdapter(private val newItem: ArrayList<OrderNewItem>, context:Context) : RecyclerView.Adapter<OrderNewRecyclerAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItem(item: OrderNewItem) {
            ...
            bg.setBackgroundColor(Color.parseColor(item.bgImage))
