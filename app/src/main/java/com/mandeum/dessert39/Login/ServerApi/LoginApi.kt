...
class LoginApi {
    ...
    companion object {
        fun login(userId: String, userPw: String, UUID: String): LoginModel1 {
            val serverUrl = "http://dessert39.man-deum.com/api/index.php?code="
            val code =
                " <CMD>login</CMD><DATA><USER_ID>$userId</USER_ID><USER_PWD>$userPw</USER_PWD><UUID>$UUID</UUID><OS>android</OS></DATA>"
