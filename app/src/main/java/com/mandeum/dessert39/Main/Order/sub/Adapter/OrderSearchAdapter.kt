...
class OrderSearchAdapter(private val menuItem: ArrayList<OrderMenuModel>) : RecyclerView.Adapter<OrderSearchAdapter.ViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): OrderSearchAdapter.ViewHolder {
